...
@protocol FJQScrollViewNetDelegate <NSObject>
...
@protocol FJQScrollViewLocalDelegate <NSObject>
...
@interface FJQScrollView : UIView

/** 选中网络图片的索引*/
@property (nonatomic, strong) id <FJQScrollViewNetDelegate> netDelagate;

/** 选中本地图片的索引*/
@property (nonatomic, strong) id <FJQScrollViewLocalDelegate> localDelagate;
